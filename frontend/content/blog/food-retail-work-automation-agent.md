...
description: "식품·유통 기업의 반복 업무를 대상으로 진행한 AI Agent PoC — PoC와 운영의 목적 차이, 기존 시스템과의 연결, 현업이 직접 만드는 Agent, 업무별 모델 선택, 그리고 두 번째 업무로 이어지는 확장 구조까지 따라가 봤습니다."
date: "2026-01-23"
...
이번 Field Report에서는 특정 기업의 업무나 시스템을 공개하기보다, 이 과정에서 확인한 **식품·유통 기업이 업무 자동화 Agent를 검토할 때 함께 살펴봐야 할 조건**을 담았습니다.
