...
description: "Separating one run's working notes from the lessons worth keeping for the next, and handling conflicts and lifecycles across session, workflow, user, and platform scopes."
date: "2026-06-22"
