...
const OUTCOMES = [
    {
        ...
        title: "AI 기반 업무혁신 정착",
        points: [
            "생성형 AI를 활용한 업무 표준화 및 반복업무 자동화",
            "문서 작성·자료 조사·보고서 작성 시간 단축으로 생산성 향상",
            "직원이 고부가가치 업무에 집중하는 업무환경 조성",
        ],
    },
    {
        no: "2",
        title: "전행 AI 활용문화 확산",
        points: [
            "누구나 쉽게 활용 가능한 AI 플랫폼 제공",
            "AI Agent 기반 업무혁신 문화 정착",
            "AI 리터러시 향상 및 AI Native 조직으로 전환",
        ],
    },
    {
        no: "3",
        ...
        points: [
            "MCP·API 기반 다양한 사내 시스템 연계",
            "공통 AI 플랫폼을 활용한 부서별 AI Agent 개발",
            "데이터·AI 자산의 지속적인 축적 및 재활용",
        ],
    },
];
