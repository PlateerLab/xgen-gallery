    ...
    return (
        <div className="overflow-hidden rounded-xl border border-[var(--color-line)] bg-[var(--color-surface-alt)]">
            <svg
                ...
                role="img"
                aria-label="이지모드 — 대화로 에이전트를 만들고 캔버스에서 노드를 조립해 쉽게 구현"
            ...
            >
                ...
                <g transform="translate(32 33)">
                    ...
                    <text x="20" y="4.5" fontSize="10" fontWeight="700" fill="#1f2b45">이지모드 · 대화형</text>
                </g>

                {/* 시스템 안내 */}
                <text x="34" y="72" fontSize="9.5" fill="#94a3b8">어떤 에이전트가 필요하세요?</text>

                {/* 사용자 말풍선(우측·블루) */}
                <rect x="78" y="80" width="126" height="26" rx="9" fill="url(#em-blue)" />
                <text x="90" y="97" fontSize="9.5" fill="#ffffff">배송 안내 챗봇 만들어줘</text>

                {/* 어시스턴트 말풍선(좌측·라이트) */}
                <rect x="32" y="118" width="150" height="44" rx="10" fill="#eef4ff" stroke="#dbe6fb" />
                <text x="44" y="135" fontSize="9.5" fill="#274268">지식·프롬프트·도구를</text>
                ...
                <text x="52" y="191.5" fontSize="9" fontWeight="700" fill="#2461d8">약 90초 완성</text>
                ...
                <g transform="translate(278 46)">
                    ...
                    <text x="17" y="1" fontSize="9.5" fontWeight="700" fill="#4a6aa8">캔버스</text>
                </g>
                ...
                <g>
                    ...
                    <text x="306" y="89.5" fontSize="9.5" fontWeight="600" fill="#1f2b45">지식</text>
                </g>
                {/* 노드: 도구(드래그 중) */}
                <g>
                    {/* 고스트(놓을 자리) */}
                    ...
                    <text x="408" y="95.5" fontSize="9.5" fontWeight="600" fill="#1f2b45">도구</text>
                    {/* 커서 */}
                ...
                <text x="343" y="169.5" fontSize="10" fontWeight="700" fill="#ffffff">에이전트 완성</text>
            </svg>
        </div>
    );
}
