        ...
        <>
            ...
            <main className="mx-auto max-w-4xl px-6 py-16">
                ...
                <Ch n={2} title="연구소의 지위와 방침의 구성" id="position">
                    ...
                    <Note>
                        연구소는 고객사에 요구하는 기준을{" "}
                        <B>먼저 우리 자신에게 적용</B>합니다. 우리가 지키지 않는 것을 고객사에
                        권고하지 않습니다.
                    </Note>
                </Ch>
                ...
                <Ch n={9} title="거버넌스 및 책임 체계" id="governance">
                    <Table
                        ...
                        rows={[
                            ...
                            [<B key="b">AI 거버넌스 위원회</B>, <span key="b2">AI 정책·원칙의 적정성 정기 평가, 고영향 AI 해당 여부 심의, 리스크 대응 방안 및 잔여 리스크 수용 여부 결정, <B>신규 AI 기능 도입·중대 변경·지원종료 승인</B>, <B>사내 AI 도구 도입 승인</B></span>],
                            [<B key="c">AI 품질책임자</B>, <span key="c2">품질 기준 수립, 릴리즈 품질 보증 활동 수행 및 월간 품질 보고, <B>위원회로부터 상시 위임받아 정기 릴리즈의 품질 승인</B>(중대 변경은 위원회 승인)</span>],
                ...
                <Ch n={10} title="이행·점검·개선 체계" id="implementation">
                    <Table
                        ...
                        rows={[
                            ...
                            ["거버넌스 정례 보고", "월 1회", "회의록, AI 품질보증활동 보고서, 이슈관리대장"],
