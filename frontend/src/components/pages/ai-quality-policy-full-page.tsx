        ...
        <>
            ...
            <main className="mx-auto max-w-4xl px-6 py-16">
                ...
                <Ch n="A2" title="거버넌스 및 책임 체계" id="annex-governance">
                    <Table
                        ...
                        rows={[
                            ...
                            [<B key="s">AI 시스템 책임자</B>, "서비스 운영 정책 승인, AI 모델·서비스의 도입·변경·폐기 결정, 배포 승인, 편향 교정 조치 결정, 장애 대응 최종 의사결정", "AI R&D 팀장"],
                    ...
                    />
                    <p>
                        AI 시스템 책임자 아래에 <B>기술지원 담당자</B>(운영·모니터링, 장애 1차 대응,
                        감사 로그 점검)와 <B>제품개발 담당자</B>(기능 등록·변경·폐기, 권한 설정,
                        지식 컬렉션 품질 관리)를 두며, 세부 업무 분장은 거버넌스 운영 절차서를
                        따릅니다.
                    </p>
                    <p>
                        역할은 겸직할 수 있으나{" "}
                ...
                <Ch n="A4" title="AI 리스크 범주 및 모니터링" id="annex-risk">
                    ...
                    <p>
                        AI 시스템의 위험 등급은{" "}
                        <B>R1(고위험) · R2(중위험) · R3(저위험)</B> 세 단계로 구분하며, 등급별 판정
                        기준과 승인 권한은 <B>거버넌스 운영 절차서</B>를 따릅니다.{" "}
                        <B>
                            R1에 해당하는 경우 사전 영향평가와 AI 거버넌스 위원회 승인을 필수로
                            하고, 사람의 감독을 반드시 둡니다.
                        </B>
                    </p>
                    <p>
                ...
                <Ch n="A5" title="이행·점검 활동" id="annex-operations">
                    <Table
                        ...
                        rows={[
                            ...
                            [<span key="ia">영향 평가 (기본권·데이터)</span>, <span key="ia2">신규 에이전트·모델 도입 또는 처리 데이터 범위 변경 시 착수 전,<br /><B>R1 시스템은 연 1회 재수행</B></span>, "영향성 평가 보고서", "2026년 하반기"],
                            ["연간 거버넌스 보고", "연 1회", <span key="ag">거버넌스 정책 검토, 위험 허용 수준 재평가 및 <B>위험등급 재분류</B>, 컴플라이언스 점검 결과</span>, "2026년 하반기"],
                ...
                <Ch n="A8" title="방침의 관리·최신화 및 문서 체계" id="annex-maintenance">
                    <Ol
                        items={[
                            ...
                            <span key="2">개정안은 <B>AI 거버넌스 위원회의 의결</B>로 확정합니다 — 본 방침은 거버넌스 운영 절차서가 정한 문서 등급 <B>L1</B>에 해당합니다.</span>,
