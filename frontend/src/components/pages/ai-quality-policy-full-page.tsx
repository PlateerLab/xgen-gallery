        ...
        <>
            ...
            <main className="mx-auto max-w-4xl px-6 py-16">
                ...
                <Ch n={8} title="AI 품질 목표" id="objectives">
                    ...
                    />
                    <Note>
                        본 지표는 조직 규모와 <B>측정 가능성</B>을 고려하여 AI 거버넌스 위원회가
                        선별한 것으로, 각 지표의 실적은 별도의 측정 활동을 두지 않고{" "}
                ...
                <Ch n={9} title="거버넌스 및 책임 체계" id="governance">
                    <Table
                        ...
                        rows={[
                            ...
                            [<B key="b">AI 거버넌스 위원회</B>, <span key="b2">AI 정책·원칙의 적정성 정기 평가, 고영향 AI 해당 여부 심의, 리스크 대응 방안 및 잔여 리스크 수용 여부 결정, <B>신규 모델·외부 AI 서비스 도입 및 지원종료 승인</B>, <B>사내 AI 도구 도입 승인</B></span>],
                            [<B key="c">AI 품질책임자</B>, <span key="c2">품질 기준 수립, <B>개발자의 검증·시험 결과를 확인하여 정기 릴리즈를 승인</B>, 월간 릴리즈 내역 확인 및 품질 보고(신규 모델·외부 AI 서비스 도입 및 지원종료는 위원회 승인 대상)</span>],
                            ...
                            [<B key="f">내부감사 조직</B>, <span key="f2">방침 이행 여부를 감사하고 시정조치를 요구. <B>감사 수행자는 자신이 수행·관리한 업무를 감사하지 않는다</B>는 독립성 요건을 충족하도록 지정</span>],
                        ]}
                    />
                    <Note>
