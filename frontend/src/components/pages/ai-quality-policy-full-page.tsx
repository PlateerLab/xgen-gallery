 ...
 *    책임 분계, 리스크, 품질 목표, 법규가 여기 있다. **이 부속을 지우면 GOV-3(정량·정성
            ...
            <main className="mx-auto max-w-4xl px-6 py-16">
                ...
                <Ch n="A2" title="거버넌스 및 책임 체계" id="annex-governance">
                    <Table
                        ...
                        rows={[
                            [<B key="a">AI 최고책임자 (CAIO)</B>, <span key="a2">AI 전략·정책의 최종 승인, AI 리스크 허용 기준 결정, AI 품질조직 구성 및 유지관리, 품질활동·점검 결과 승인, <B>A3 책임 분계 범위 내에서 제품 결함으로 발생한 피해에 대한 최종 책임</B></span>, "총괄책임자"],
                    ...
                    <p>
                        거버넌스 기구 구성원 및 AI 최종 책임 주체는 AI 특유의 위험(환각, 편향,
                        프롬프트 인젝션, 데이터 유출, 외부 도구 연계 오남용 등)에 대한 교육을{" "}
                        <B>연 1회 이상 필수</B>로 이수합니다.
                    </p>
                </Ch>

                <Ch n="A3" title="공급자와 도입 고객사의 책임 분계" id="annex-responsibility">
                    <p>
                        연구소의 제품은{" "}
                ...
                <Ch n="A5" title="이행·점검 활동" id="annex-operations">
                    <Table
                        head={["활동", "주기", "산출물"]}
                        rows={[
                            ["AI 품질 관리 활동 모니터링", "상시", "모니터링 관리 대장·이슈관리대장, 이상징후 보고서"],
                            ["거버넌스 정례 보고", "월 1회", "회의록, AI 품질보증활동보고서"],
                            ["릴리즈 품질 검증", "릴리즈 시마다", "릴리즈 시험 결과서, 승인 기록, 릴리즈 노트"],
                            ["사내 AI 이용 현황 점검", "반기 1회", "AI 도구 대장"],
                            ["리스크 재평가", "반기 1회 및 중대 이벤트 발생 시", "리스크 평가서, 리스크 조치 결과서"],
                            ["영향 평가 (기본권·데이터)", "신규 에이전트·모델 도입 또는 처리 데이터 범위 변경 시, 착수 전", "영향성 평가 보고서"],
                            ["내부감사", "연 1회 이상", "내부감사 절차 이행 보고서, 시정조치 계획 및 효과성 평가서"],
                            [<span key="mr">경영검토 및<br />방침·정책 적정성 평가</span>, <span key="mr2">연 1회 이상<br />(통합 개최)</span>, "경영 검토 결과 보고서, 정책 적정성 평가 이행 기록서"],
                        ]}
                    />
                    <H3>거버넌스 정례 보고 항목</H3>
                    <p>
                    ...
                    <p>
                        ...
                        절차를 이행하며, 처리 결과와 재발 방지 대책은 거버넌스 정례 보고를 통해
                        검토·승인됩니다.
                    </p>
                </Ch>
                ...
                <Ch n="A6" title="AI 품질 목표" id="annex-objectives">
                    ...
                    />
                    <Note>
                        &ldquo;2026년 하반기&rdquo;로 표시된 지표는 선행 기준 문서의 확정을 전제로
                        하며, 확정 시점부터 측정을 시작합니다.{" "}
                        <B>지표를 세우되 아직 측정하지 않는 구간을 감추지 않습니다.</B>
                    </Note>
                    ...
                    <Table
                        ...
                        rows={[
                            [
                                <B key="v3">v3.0</B>,
                                "2026-08-11",
                                "전면 재구성 — 신뢰성·안정성·보안·통제 가능성을 앞세운 서술 구조(01~10)로 개편하고, 적용 범위·거버넌스·품질 목표·법규 등 관리 체계 상세는 부속으로 재배치. 내용의 삭제 없이 독자별 구성만 변경",
                                "플래티어 AI연구소 총괄책임자",
                            ],
                            [
                                <B key="v2">v2.0</B>,
                                "2026-08-11",
                                "개정 — 원칙별 이행 수단 구체화, 인력 리스크를 포함한 AI 리스크 범주 신설, 관련 법규 조항 신설, 품질 목표를 조직·제품 2층으로 확대, 거버넌스 정례 보고 항목 명시, 모니터링 4축 체계 반영",
                                "플래티어 AI연구소 총괄책임자",
                            ],
                            [
                                <B key="v1">v1.0</B>,
