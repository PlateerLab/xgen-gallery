                ...
                <Ch n={8} title="AI 품질 목표" id="objectives">
                    ...
                    <Table
                        ...
                        rows={[
                            ...
                            ["위험관리", "리스크 평가(Risk Assessment) 수행률", "100%", "운영 중"],
                    ...
                    />
                    <Note>
                        <B>측정 개시</B> — &ldquo;2026년 하반기&rdquo;로 표시된 지표는 선행 기준
                        문서(개발 표준 정의서, 리스크 등급 기준, 메타데이터 정의서)의 확정을
                        전제로 하며, 확정 시점부터 측정을 시작합니다.{" "}
                        <B>지표를 세우되 아직 측정하지 않는 구간을 감추지 않습니다.</B>
                        <br />
                        사고 등급별 복구 목표시간은 거버넌스 운영 절차서에 정의된 등급별 기준을
                        따릅니다.
                    </Note>
                    <H3>8.2 제품 품질 목표 (2026년도)</H3>
                    <p>
                        제품 품질은 다음 지표로 관리하며, 각 지표의{" "}
                        <B>
                            세부 목표 수치는 과제·제품 특성에 따라 달라지므로 내부 품질 기준에서
                            정하고
                        </B>{" "}
                        변경 시 개정 이력으로 관리합니다.
                    </p>
                    ...
                    />
                    <Note>
                        <B>보안 지표에 관하여</B> — 프롬프트 인젝션에 대한 완전한 방어는 현재 기술
                        수준에서 보장할 수 없습니다. 연구소는 방어 성공률을 공약하는 대신{" "}
                        <B>모든 릴리즈에 대해 레드팀 테스트를 빠짐없이 수행할 것</B>을 약속하며,
                        탐지된 취약점은 10.5의 사고 대응 절차에 따라 조치합니다.
                    </Note>
                    <Note>
