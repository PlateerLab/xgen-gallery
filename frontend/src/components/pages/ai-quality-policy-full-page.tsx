            ...
            <main className="mx-auto max-w-4xl px-6 py-16">
                ...
                >
                    ...
                    <p>
                        ...
                        <B>반기 1회 점검</B>하여 AI 거버넌스 협의체에 보고합니다.
                    </p>
                    <Note>
                ...
                <Ch n="A2" title="거버넌스 및 책임 체계" id="annex-governance">
                    <Table
                        ...
                        rows={[
                            ...
                            [<B key="b">AI 거버넌스 협의체</B>, "AI 정책·윤리기준 심의 및 적정성 정기 평가, 고영향 AI 해당 여부 심의, 고위험 변경사항 승인·기각, 리스크 대응 방안 및 잔여 리스크 수용 여부 결정, 신규 모델·외부 AI 서비스 도입 및 지원종료 승인, 사내 AI 도구 도입 승인", "—"],
                    ...
                    <p>
                        AI 거버넌스 협의체 구성원 및 AI 최종 책임 주체는 AI 특유의 위험(환각, 편향,
                ...
                <Ch n="A4" title="AI 리스크 범주 및 모니터링" id="annex-risk">
                    ...
                    <p>
                        ...
                        대응 원칙은 AI 거버넌스 협의체의 승인을 거쳐 정합니다.
                    </p>
                    <p>
                        배포된 AI 시스템은{" "}
                ...
                <Ch n="A5" title="이행·점검 활동" id="annex-operations">
                    <Table
                        ...
                        rows={[
                            ...
                            ["AI 거버넌스 협의체 정기 회의", "분기 1회 이상", "안건 제안서, 회의록, 회의 결과 보고서", "2026년 하반기"],
                    ...
                    <p>
                        ...
                        절차를 이행하며, 처리 결과와 재발 방지 대책은 AI 거버넌스 협의체 정기
                        회의에서 검토·승인됩니다.
                    </p>
                </Ch>
                ...
                <Ch n="A6" title="AI 품질 목표" id="annex-objectives">
                    <p>
                        ...
                        기구에 정기 보고합니다. 목표는 연 1회 AI 거버넌스 협의체의 심의를 거쳐
                        수립합니다.
                    </p>
                ...
                <Ch n="A8" title="방침의 관리·최신화 및 문서 체계" id="annex-maintenance">
                    <Ol
                        items={[
                            ...
                            "개정안은 AI 거버넌스 협의체의 심의와 AI 최고책임자의 승인을 거쳐 확정합니다.",
