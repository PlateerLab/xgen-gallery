...
const COPY: Record<Locale, Copy> = {
    ko: {
        ...
        h1: ["Enterprise AI의 신뢰는", "체계적인 관리와 통제에서 완성됩니다"],
        heroLead: [
            "플래티어 AI연구소는 AI를 개발하고 실제 기업 환경에 적용합니다.",
            "AI의 성능뿐만 아니라 안전성·책임성·통제 가능성을 제품과 운영 전반에 적용하여, 고객이 신뢰하고 지속적으로 운영할 수 있는 Enterprise AI를 만들어갑니다.",
        ],
        breadcrumb: "AI 품질 방침",
        ...
        qualityNote:
            "XGEN은 이러한 요구사항을 제품과 운영 전반에서 관리할 수 있도록 설계되었습니다.",
        principlesTitle: "우리의 원칙",
        principlesLead:
            "연구소는 다음 일곱 가지 원칙을 모든 AI 제품 개발과 운영의 기준으로 삼습니다.",
        principles: [
            ["Human-in-the-Loop", "중요한 AI 판단과 실행은 사람이 검토·승인·중단할 수 있도록 합니다."],
            ["Quality Before Release", "정의된 품질 기준에 따라 검증을 완료한 AI 기능만 배포합니다."],
            ["Data Quality First", "AI에 활용되는 데이터의 출처와 변경 이력을 관리하고 품질을 지속적으로 점검합니다."],
            ["Explainable AI", "AI 결과의 근거와 주요 처리 과정을 확인할 수 있도록 합니다."],
            ["Fairness by Design", "AI의 편향 위험을 사전에 식별하고 지속적으로 점검·관리합니다."],
            ["Accountability", "공급자와 운영자의 역할과 책임을 명확히 구분하고, 공급자로서의 책임을 투명하게 이행합니다."],
            ["Continuous Improvement", "이해관계자의 의견과 규제 변화를 지속적으로 반영합니다."],
        ],
        productTitle: "AI 품질 원칙을 제품 기능으로 구현합니다",
        productLead:
            "AI 품질은 원칙을 선언하는 것만으로 완성되지 않습니다. XGEN은 AI 거버넌스, 가드레일, 권한 관리, 감사 로그, 모델 관리, 실행 이력 및 품질 평가 기능을 통해 AI를 실제 운영 환경에서 관리하고 통제할 수 있도록 지원합니다.",
        features: [
        ...
        commitNote:
            "플랫폼 공급자와 고객사의 역할 및 책임에 대한 상세 기준은",
        commitNoteLink: "AI 품질 방침 전문",
        ...
        ctaDesc:
            "플래티어 AI연구소가 Enterprise AI의 신뢰성과 안정성을 확보하기 위해 적용하는 품질 기준과 거버넌스 체계, 개발·운영 원칙, 공급자와 고객사의 역할 및 책임을 공개합니다.",
        ctaFull: "전문 보기",
        ctaContact: "문의하기",
        docNo: "문서번호",
        docVersion: "버전",
        ...
        docNext: "차기 정기 검토",
        docApprover: "검토",
        docApproverValue: "플래티어 AI연구소 총괄책임자",
        footerOrg: "플래티어 AI연구소 (Plateer AI Lab)",
        footerContact: "AI 품질·윤리 문의 및 AI 사고 신고",
    },
    en: {
        eyebrow: "AI Quality Policy · Plateer AI Lab",
        h1: ["Trust in enterprise AI", "is completed by disciplined management and control"],
        heroLead: [
        ...
        principles: [
            ["Human-in-the-Loop", "Significant AI judgements and actions can be reviewed, approved, or stopped by a person."],
            ["Quality Before Release", "Only AI capability that has completed verification against the defined quality criteria ships."],
            ["Data Quality First", "We manage the provenance and change history of the data AI uses, and check its quality continuously."],
            ["Explainable AI", "The basis for an AI result and the main steps behind it can be confirmed."],
            ["Fairness by Design", "Bias risk is identified in advance and inspected and managed continuously."],
        ...
        productTitle: "We implement our AI quality principles as product capability",
        productLead:
        ...
        oursTitle: "The role of Plateer AI Lab",
        ours: [
        ...
        theirsTitle: "The customer's operating and management area",
        theirs: [
        ...
        commitNote:
            "The detailed criteria for the roles and responsibilities of the platform supplier and the customer are in",
        commitNoteLink: "the full AI quality policy (Korean)",
        ...
        docApprover: "Reviewed by",
        docApproverValue: "Head of Plateer AI Lab",
